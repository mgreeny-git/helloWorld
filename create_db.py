...
with app.app_context():
    ...
    users = [
        ...
        {'username': 'mgreeny', 'email': 'mgreeny@terpmail.umd.edu', 'first_name':'Matthew', 'last_name':'Greenawalt',
            'password': generate_password_hash('mgreeny', method='sha256'), 'role':'STUDENT'}
    ]
